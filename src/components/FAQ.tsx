...
const faqs = [
    {
        question: '畢業禮在室內禮堂舉行，直播效果會受影響嗎？',
        answer:
            '完全不會。室內活動我們會根據禮堂燈光調整設備配置，確保畫面清晰明亮。收音方面亦會接駁禮堂音響系統，確保講話及音樂清楚傳達。',
    },
    {
        question: '畢業禮通常幾耐？需要幾多部機？',
        answer:
            '一般畢業禮約 1.5–2.5 小時。我們建議最少 2 機位（台上特寫 + 全景），標準方案為 3 機位，確保全方位覆蓋。',
    },
    {
    ...
    },
    {
        question: '需要提前多久預約？',
        answer:
            '建議於活動前 1–2 個月查詢。畢業禮旺季（6–7 月）檔期非常緊張，建議盡早聯繫。年度合約客戶享有優先排期。',
    },
    {
